...
class RideCategories extends React.Component {
  ...
  componentDidMount = () => {
    ...
    //        }
    //    }
    //    axios.post('https://apis.cab5.pk/fetch_all_ride_categories.php', params, config)

    //        .then(res => {
    //          console.log(res.data.data.ride_categories);
    //          this.setState({...this.state,ride_categories: res.data.data.ride_categories})
    //          console.log(this.state.ride_categories)
    //        })
    ...
    axios
      ...
      .then((response) => {
        ...
        this.setState({ ...this.state, ride_categories: response.data.data });
      })
      .catch((error) => {
        console.log(error);
      });
  ...
  this.setState({
    ...
    checked: !(this.state.checked),
                                    ...
                                    <label class="switch">
                                      {user["enabled"] === "Y" ? (
                                        <input
                                          ...
                                          onChange={(e) => {
                                            this.setState({
                                              ride_category_uid: e.target.value,
                                            });
                                          }}
                                          onClick={() => {
                                            const params = new FormData();
          ...
          <div
            className={"add-btn"}
            onClick={() => {
              urlArgsBundle.setActivityTag(ACTIVITY_TAG.ADD_RIDE_CATEGORY);
...
export default withRouter(RideCategories);
