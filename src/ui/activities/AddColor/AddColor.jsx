...
class AddColor extends React.Component {
    ...
    getModel = () => {
        ...
        //     }
        // }
        // axios.post('https://apis.cab5.pk/fetch_vehicle_model.php', params, config)

        //     .then(res => {
        //         console.log(res.data.data.cities);
        //         this.setState({...this.state,vehicle_models: res.data.data.vehicle_models})
        //         console.log(this.state.vehicle_models)
        //     })
        ...
        .then((response) => {
          console.log(JSON.stringify(response.data));
          this.setState({...this.state,vehicle_models: response.data.data})
        })
        .catch((error) => {
          console.log(error);
        });
    ...
    sendDataToRegisterApi = () => {
        ...
        // params.append('vehicle_model_uid',this.state.vehicle_model_uid);
        ...
        // axios.post('https://apis.cab5.pk/add_vehicle_color.php', params, config)
        ...
        //         }
        //     })
        if (this.state.vehicle_brand_uid&&this.state.vehicle_model_uid&&this.state.color) {
        let data = qs.stringify({
            'brand': this.state.vehicle_brand_uid,
            'model': this.state.vehicle_model_uid,
          ...
          axios.request(config)
          .then((response) => {
            toast.success("Vehicle Color Add Successfully")
            setTimeout(() => {
                const urlArgsBundle = (new UrlArgsBundle()).prepareFrom(this.props.location.search);
            urlArgsBundle.setActivityTag(ACTIVITY_TAG.VEHICLE_COLOR)
            this.props.history.push(urlArgsBundle.getArgsAsUrlParams())
                                            ...
                                            <div className="basic-form">
                                                    <div className="form-row">
                                                        ...
                                                        <div className="form-group col-md-4">
                                                            ...
                                                            <select id="inputState" className="form-control"
                                                                    onChange={e=>{
                                                                        this.setState({...this.state, vehicle_model_uid :e.target.value})
                                                                    }}
                                                            >
                                                                <option>Choose...</option>
                                                                {this.state.vehicle_models.map(
                                                                    show =>      <option value={show['model']}>{show['model']}</option>
                                                                )}
                                                        ...
                                                        <div className="form-group col-md-6">
                                                            ...
                                                            <input type="text"
                                                                   ...
                                                                   className="form-control" placeholder='vehicle color' />
                                                        </div>
                                                    </div>
                                                    <div className="form-row">
