...
class SupportSystem extends React.Component {
                        ...
                        <div className="container-fluid">
                            ...
                            <div style={{display:'flex',gap:'8px'}}>
                                ...
                                onClick={()=>{
                                 ...
                                 className='btn btn-danger' style={{backgroundColor:'#00B106',borderColor:'#00B106'}}> Rider Support</button>
                                <button onClick={()=>{
                                urlArgsBundle.setActivityTag(ACTIVITY_TAG.USER_SUPPORT_SYSTEM)
                                this.props.history.push(urlArgsBundle.getArgsAsUrlParams())
                            }} className='btn btn-danger'  style={{backgroundColor:'#fff',borderColor:'#00B106',color:'#00B106'}}>User Support</button>
                            </div>
...
export default withRouter(SupportSystem);