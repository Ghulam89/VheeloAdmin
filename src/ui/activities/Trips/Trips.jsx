...
class Trips extends React.Component {
    ...
    componentDidMount = () => {
        ...
        //        }
        //    }
        //    axios.post('https://apis.cab5.pk/get_all_trips_detail.php', params, config)
        ...
        axios.request(config)
            .then((response) => {
                ...
                this.setState({ ...this.state, trips: response.data.data })
            })
            .catch((error) => {
                console.log(error);
            });
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <div className="d-flex align-items-center">
                                                                        ...
                                                                        <span className="w-space-no">{trip?.riderData?.firstName + " " + trip?.riderData?.lastName

                                                                        }</span>
                                                                    </div>
                                                                </td>
                                                                <td>{trip?.userData?.firstName + " " + trip?.userData?.lastName}</td>
                                                                <td>
                                                                    {trip?.riderData?.phone}
                                                                </td>
                                                                <td>{trip?.rideData?.createdAt}</td>
                                                                <td>{trip?.rideData?.pickupLocation + " " + trip?.rideData?.dropLocation
                                                                }
                                                                </td>
                                                            </tr>
                                                        )}
