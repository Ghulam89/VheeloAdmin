                            ...
                            <div className="page-titles">
                                <ol className="breadcrumb">
                                    ...
                                    <li className="breadcrumb-item active">
                                        <a href="/react/demo/table-bootstrap-basic">Transaction</a>
                                    </li>
                                </ol>
                            </div>
                            <div className="row">
                                <div className="col-lg-12">
                                    ...
                                    <div className="card-header">
                                            <div className="card-title h5">Unapproved Driver</div>
                                ...
                                <div className="col-md-12 all_col">
                                <div className="card pb-4">
                                    <div className="card-header">
                                            <div className="card-title h5">Approved Driver</div>
