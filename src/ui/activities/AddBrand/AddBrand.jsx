...
class AddBrand extends React.Component {
  ...
  sendDataToRegisterApi = () => {
    ...
    // params.append('vehicle_brand_name',this.state.vehicle_brand_name);
    ...
    // axios.post('https://apis.cab5.pk/create_vehicle_brand.php', params, config)
    ...
    //         }
    //     })
    if (this.state.vehicle_brand_name && this.state.type) {
      let data = qs.stringify({
        brand: this.state.vehicle_brand_name,
      ...
      axios
        .request(config)
        .then((response) => {
          toast.success("Vehicle Brand Add Successfully");
          setTimeout(() => {
                            ...
                            <div className="form-group col-md-6">
                              ...
                              <input
                                ...
                                onChange={(e) => {
                                  this.setState({
                                    ...this.state,
                                    vehicle_brand_name: e.target.value,
                                  });
                                }}
                              />
                            </div>
