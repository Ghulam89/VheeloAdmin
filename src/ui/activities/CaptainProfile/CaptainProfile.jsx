...
class CaptainProfile extends React.Component {
  ...
  componentDidMount = () => {
    ...
    //     const path = localStorage.getItem('captain_uid');

    //     params.append('captain_uid',path);
    ...
    //        }
    //    }
    //    axios.post('https://apis.cab5.pk/fetch_captain.php', params, config)

    //        .then(res => {
    //          console.log(res.data);
    //          this.setState({...this.state,captain
    //             : res.data.data.captain
    //         })
    //          console.log(this.state.captain)

    //        })

    const id = localStorage.getItem("captain_id");
    let config = {
      method: "get",
    ...
    axios
      ...
      .then((response) => {
        ...
        this.setState({ ...this.state, captain: response.data.data.riderData });
        this.setState({ ...this.state, vehicle: response.data.data.vehicleInfo });
        ...
        .request(config3)
        .then((response) => {
          console.log(response.data,'single document');
          this.setState({ ...this.state, category: response.data.data});
        })
        .catch((error) => {
          console.log(error);
        });
    ...
    axios
      ...
      .then((response) => {
        console.log(response.data,'single');
        this.setState({ ...this.state, document: response.data.data });
      })
      .catch((error) => {
        console.log(error);
      });
    ...
    axios
      ...
      .then((response) => {
        ...
        this.setState({ ...this.state, getWallet: response.data.riderWallet });
      })
      .catch((error) => {
        console.log(error);
      });
 ...
 "balance":Number(this.state.wallet) + Number(this.state.getWallet.balance)
    ...
    axios
      .post(
        `${BASE_URL}admin/walletRider/add`,
        params,
                      ...
                      <div className="profile-inner p-3">
                        ...
                        <div className="tabs">
                          <ul className="tabs_list">
                            <li
                              className={`tabs_link ${
                                this.state.update === 0 ? "active" : null
                              }`}
                              onClick={() => {
                            ...
                            <li
                              className={`tabs_link ${
                                this.state.update === 1 ? "active" : null
                              }`}
                              onClick={() => {
                            ...
                            <li
                              className={`tabs_link ${
                                this.state.update === 2 ? "active" : null
                              }`}
                              onClick={() => {
                            ...
                            <li
                              className={`tabs_link ${
                                this.state.update === 3 ? "active" : null
                              }`}
                              onClick={() => {
                            ...
                            <li
                              className={`tabs_link ${
                                this.state.update === 4 ? "active" : null
                              }`}
                              onClick={() => {
                            ...
                            <li
                              className={`tabs_link ${
                                this.state.update === 5 ? "active" : null
                              }`}
                              onClick={() => {
                          ...
                          <div className="nav_tabs">
                            <div
                              ...
                              hidden={this.state.update != 0}
                            >
                              <div className="innner_tabs">
                                <p>{this.state.captain.city_name}</p>
                                <p>Phone: {this.state.captain.phone}</p>
                                <p>{this.state.captain.registration_time}</p>
                              </div>
                            </div>
                            <div
                              className="tabsContent pt-5"
                              hidden={this.state.update != 1}
                            >
                              <div className="row">
                                ...
                                <div className="pl-4">
                                  <button
                                    ...
                                    onClick={() => {
                                      ...
                                      //   toast("Pleasse Enter Amount First");
                                      // } else {
                                      //   this.sendDataToRegisterApi();
                                      // }
...
export default withRouter(CaptainProfile);
