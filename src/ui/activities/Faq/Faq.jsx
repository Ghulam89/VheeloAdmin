  ...
  componentDidMount = () => {
    ...
    axios
      ...
      .then((response) => {
        ...
        this.setState({ ...this.state,FAQs: response.data.FAQs});
      })
      .catch((error) => {
        console.log(error);
      });
      ...
      <div className={"login-activity"}>
        <div className="">
                                ...
                                <tr>
                                  ...
                                  <td>
                                    <div className="d-flex align-items-center">
                                      ...
                                      <span className="w-space-no">{user?.question}</span>
                                    </div>
                                  </td>
                                  <td>{user.answer}</td>
                                  {/* <td>
          ...
          <div
            className={"add-btn"}
            onClick={() => {
              urlArgsBundle.setActivityTag(ACTIVITY_TAG.ADD_FAQ);
