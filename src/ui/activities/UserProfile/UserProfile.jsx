...
class UserProfile extends React.Component {
  ...
  componentDidMount = () => {
    ...
    // );
    // const path = localStorage.getItem("uid", user.uid);

    // params.append("user_uid", path);
    ...
    // };
    // axios
    //   .post("https://apis.cab5.pk/fetch_single_user.php", params, config)
    ...
    axios
      ...
      .then((response) => {
        ...
        this.setState({ ...this.state, user: response.data.data });
  ...
  sendDataToRegisterApi = () => {
    ...
    params.append("user_uid", this.state.user.uid);

    params.append("amount", this.state.wallet);
  ...
  render() {
    ...
    // const path2 = pathname.slice(pathname.indexOf('/',1)+1,pathname.length)
    // console.log(path2);
                          ...
                          <div className="nav_tabs">
                            ...
                            >
                              <div className="innner_tabs">
                                ...
                                <p>
                                  Member Since:{this.state.user?.createdAt}
                                </p>
                              </div>
                            </div>
                            <div
                            ...
                            >
                              <h4>Amount:{this.state.user.wallet}</h4>
