...
class Captains extends React.Component {
    ...
    componentDidMount = () => {
        ...
        //        }
        //    }
        //    axios.post('https://apis.cab5.pk/fetch_captains.php', params, config)

        //        .then(res => {
        //          console.log(res.data);
        //          this.setState({...this.state,captains: res.data.data.captains}) 
        ...
        axios.request(config)
            .then((response) => {
                ...
                this.setState({ ...this.state, captains: response.data.data })
            })
            .catch((error) => {
                console.log(error);
            });
                                                            ...
                                                            <tr >
                                                                ...
                                                                <td>
                                                                    <td><label class="switch">
                                                                        {captain['blocked'] == true ? (<input
                                                                            type="checkbox" defaultChecked defaultValue={captain['uid']} onChange={e => {
                                                                                this.setState({ blocked: e.target.value })
                                                                            }} onClick={() => {
                                                                                const params = new FormData();
                                                                                ...
                                                                                axios.post('https://apis.cab5.pk/toggle_captain_block.php', params, config)
                                                                                ...
                                                                                type="checkbox" defaultValue={captain['uid']} onChaxnge={e => {
                                                                                    this.setState({ blocked: e.target.value })
                                                                                }} onClick={() => {
                                                                                    const params = new FormData();
                                                                ...
                                                                <td> <button onClick={() => {
                                                                    ...
                                                                    localStorage.setItem('captain_id', captain.id)
                                                                    urlArgsBundle.setActivityTag(ACTIVITY_TAG.CAPTAIN_PROFILE)
