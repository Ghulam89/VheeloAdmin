...
class AddRideCategory extends React.Component {
    ...
    sendDataToRegisterApi = async() => {
        ...
        // params.append("image", this.state.files);
        // params.append("enabled", this.state.enabled);
        // params.append("type", this.state.type);
        // params.append("per_km_price", this.state.per_km_price);
        ...
        //     }
        // }
        // axios.post('https://apis.cab5.pk/add_ride_category.php', params, config)
                                        ...
                                        <div className="card-body">
                                            <div className="basic-form">
                                                ...
                                                <div className="form-row">
                                                    ...
                                                    <div className="form-group col-md-4">
                                                        ...
                                                        <select id="inputState" className="form-control"
                                                            value={enabled}
                                                            onChange={e => { this.setState({ ...this.state, enabled: e.target.value }) }}
                                                        >
                                                ...
                                                <button
                                                    ...
                                                    onClick={this.sendDataToRegisterApi} className="btn btn-add">
                                                    Add
                                                </button>
...
export default withRouter(AddRideCategory);