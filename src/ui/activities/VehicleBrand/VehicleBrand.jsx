...
class VehicleBrand extends React.Component {
  ...
  componentDidMount = () => {
    ...
    //          this.setState({...this.state,vehicle_brand: res.data.data.vehicle_brand})
  ...
  handleCheckboxChange = (itemId) => {
    this.setState((prevState) => ({
      data: prevState.vehicle_brand.map((item) =>
      ...
      <div className={"login-activity"}>
        <div className="">
                                  ...
                                  <td>
                                    <div className="custom-control custom-checkbox checkbox-success check-lg mr-3">
                                      <input
                                        ...
                                        onChange={() => this.handleCheckboxChange(brand.id)}
          ...
          <div
            className={"add-btn"}
            onClick={() => {
              urlArgsBundle.setActivityTag(ACTIVITY_TAG.ADD_BRAND);
...
export default withRouter(VehicleBrand);
