...
class Cities extends React.Component {
  ...
  componentDidMount = () => {
    ...
    //     }
    // }
    // axios.post('https://apis.cab5.pk/fetch_all_cities.php', params, config)

    //     .then(res => {
    //         console.log(res.data.data.cities);
    //         this.setState({ ...this.state, cities: res.data.data.cities })
    ...
    let config = {
      ...
      url: `${BASE_URL}admin/city/getAll`,
      headers: {},
      data: data,
    };
    ...
    axios
      .request(config)
      .then((response) => {
        this.setState({ ...this.state, cities: response.data.data });
        console.log(this.state.cities);
      })
      .catch((error) => {
        console.log(error);
      ...
      <div className={"login-activity"}>
        <div className="">
                ...
                <div className="page-titles">
                  <ol className="breadcrumb">
                    ...
                    <li className="breadcrumb-item active">
                      <a href="/react/demo/table-bootstrap-basic">Cities</a>
                    </li>
                  </ol>
                </div>
                <div className="row">
                  <div className="col-lg-12">
                    <div className="card">
                      <div className="card-header">
                        <div className="card-title h5">Cities</div>
                      </div>
                                      ...
                                      {show["enabled"] === "Y" ? (
                                        <input
                                          ...
                                          onClick={() => {
                                            ...
                                            params.append("city_uid", show.uid);
                                            ...
                                            axios
                                              .post(
                                                "https://apis.cab5.pk/toggle_city_enable_disable.php",
                                                params,
                                                config
                                              )
          ...
          <div
            className={"add-btn"}
            onClick={() => {
              urlArgsBundle.setActivityTag(ACTIVITY_TAG.ADD_CITY);
