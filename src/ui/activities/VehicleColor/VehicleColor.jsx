...
class VehicleColor extends React.Component {
    ...
    //        }
    //    }
    //    axios.post('https://apis.cab5.pk/fetch_vehicle_colors.php', params, config)
       
    //        .then(res => {
    //          console.log(res.data);
    //          this.setState({...this.state,vehicle_brand: res.data.data.vehicle_colors})
    ...
    .then((response) => {
      ...
      this.setState({...this.state,vehicle_brand: response.data.data})
    })
    .catch((error) => {
      console.log(error);
    });
                                            ...
                                            <div className="table-responsive">
                                                <table className="table">
                                                    ...
                                                    <tbody>
                                                    {
                                                        ...
                                                        this.state.vehicle_brand.map((brand,index)=>
                                                            <tr key={index}>
                                                                <td>
                                                                    <div className="custom-control custom-checkbox checkbox-success check-lg mr-3">
                                                                        <input
...
{}
                                                                ...
                                                                <td>
                                                                    <div className="d-flex align-items-center">
                                                                        ...
                                                                        <span className="w-space-no">{brand.model}</span>
                                                                    </div>
                                                                </td>
                                                                <td>
                                                                    <div className="d-flex align-items-center">

                                                                        <span className="w-space-no">{brand.color}</span>
                                                                    </div>
                                                                </td>
                ...
                <div className={"add-btn"}     onClick={()=>{
                    urlArgsBundle.setActivityTag(ACTIVITY_TAG.ADD_COLOR)
...
export default withRouter(VehicleColor);